            ...
            <div class="border border-surface-container-highest/8xl rounded-xl p-6 md:p-10 bg-surface-container-lowest">
                ...
                <div class="mb-8 text-center border-b border-surface-container-highest pb-6">
                    ...
                    <p class="font-body-md text-sm text-on-surface-variant max-w-md mx-auto leading-relaxed">
                        Update the details of your category to reflect any changes in its name, slug, or description.
                    </p>
                </div>

                <!-- Form -->
                <form class="space-y-5" action="{{ route('dashboard.categories.update', $category->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div
                                ...
                                <input
                                    ...
                                    id="section-slug" name="slug" placeholder="e.g., culture" type="text" value="{{ old('slug', $category->slug) }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea
                            ...
                            placeholder="Describe the scope of this section and what type of content readers can expect..." rows="3">{{ old('description', $category->description) }}</textarea>
                    </div>
